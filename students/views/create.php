...
<body>
  <div class="main-block">
    <div class="left-part">
      ...
      <h1>Register to  New Student </h1>
      <p> welcome to Our university</p>
      <div class="btn-group">
        <a class="btn-item" href="https://github.com/mannan-web-dev">Github</a>
    ...
    <form action="./store.php" method="post" enctype="multipart/form-data">
      ...
      <div class="info">
        ...
        <input type="text" name="id" placeholder="Enter your Student number" required>
      </div>
